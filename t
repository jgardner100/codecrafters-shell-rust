In this stage, you will implement support for quoting with double quotes.
Double Quotes

In shell syntax, most characters within double quotes (") are treated literally. However, double quotes allow certain special characters to be interpreted (like $ for variables and \ for escaping), but we will cover those exceptions in later stages.
...
$ echo "shells test"
shells test           # Single quotes inside are literal
